...
outputFolder = fullfile(pwd,'loveda'); 
...
rng(0)
%% Load CamVid Images
imgDir = fullfile(outputFolder,'Train','Train','Urban','images_png');
...
labelIDs = grayscaleColorID();

labelDir = fullfile(outputFolder,'Train','Train','Urban','masks_png');
...
imgDir = fullfile(outputFolder,'Val','Val','Urban','images_png');
imdsVal = imageDatastore(imgDir);
labelDir = fullfile(outputFolder,'Val','Val','Urban','masks_png');
